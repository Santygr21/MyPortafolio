  ...
  return (
    <div
      ...
      <div
        ...
        <div
          className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-primary blur-2xl"></div>
        <div
        ...
        <div
          className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-primary "></div>
      </div>
